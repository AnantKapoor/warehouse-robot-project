...
public class Run {
	...
	public static void main() {
		...
		dropPoint1.addCoordinates(new Point (dropLocations.get(0).getX(), dropLocations.get(0).getY()));
		dropPoint2.addCoordinates(new Point (dropLocations.get(1).getX(), dropLocations.get(1).getY()));
		dropPoint3.addCoordinates(new Point (dropLocations.get(2).getX(), dropLocations.get(2).getY()));
